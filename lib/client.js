...
function BlockchainClient(options) {  
  ...
  this.includeWatchOnly = (options.includeWatchOnly) ? options.includeWatchOnly : false;
...
BlockchainClient.prototype = {
  ...
  listNextBlock: function(previousBlockHash, callback) {
    var _this = this;
    _this.coinDaemon.exec('listsinceblock', previousBlockHash, _this.confirmations, _this.includeWatchOnly,
